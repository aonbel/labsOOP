...
public class CreditRepository(IOptions<PostgresOptions> options) : ICreditRepository
{
    ...
    public async Task<int> AddAsync(CreditDto entity, CancellationToken cancellationToken)
    {
        ...
        const string sqlQuery = """
                                ...
                                (bankrecordid, interestrate, amount, lastupdatedat, createdat, closedat, terminmonths, isapproved) 
                                VALUES
                                (@bankrecordid, @interestrate, @amount, @lastupdatedat, @createdat, @closedat, @terminmonths, @isapproved)
                                RETURNING id
                                """;
